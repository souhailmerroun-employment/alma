            ...
            <div className="container-fluid w-full flex flex-wrap items-center justify-between px-6">
                ...
                <div className="collapse navbar-collapse flex-grow items-center" id="navbarSupportedContent">
                    ...
                    <ul className="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
                        <li className="nav-item px-2"><Link className="nav-link active" to={ROUTE_HOME}>Home</Link></li>
                        <li className="nav-item px-2"><Link className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" to={ROUTE_ABOUT}>About</Link></li>
                        <li className="nav-item px-2"><Link className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" to={ROUTE_PAYMENTS}>Payments</Link></li>
                    </ul>
                </div>
            </div>
        </nav>
